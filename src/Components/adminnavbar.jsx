...
const AdminNavbar = ({ isOpenProp = false }) => {
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // State to manage navbar visibility on mobile
    ...
    return (
        <div>
            ...
            <div className={`fixed top-0 left-0 h-full w-1/5 bg-gray-900 text-white p-4 z-50 transform transition-transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:block`}>
                {/* Branding/logo */}
                ...
                <ul className="space-y-4 mt-16">
                    ...
                    <li>
                        <a href="/admin-ai-duty-leave" className="block p-2 hover:bg-blue-800 rounded">Attendance</a>
                    </li>
                    <li>
