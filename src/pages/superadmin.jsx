        ...
        <div className="flex h-screen">
            ...
            <div className="flex w-2/3">
                ...
                <div className="flex flex-col ml-20 justify-center w-1/2 p-4 space-y-6">
                    {/* Button B1 */}
                    <button
                        className="w-full h-40 mt-14 rounded-md hover:opacity-80 mx-auto bg-cover bg-center text-white text-xl font-bold"
                    ...
                    {/* Button B2 */}
                    <button
                        className="w-full h-40 rounded-md hover:opacity-80 mx-auto bg-cover bg-center text-white text-xl font-bold"
