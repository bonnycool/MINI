                ...
                <div className="flex flex-col lg:flex-row h-full">
                    <div className="mb-4 mt-8">
                        ...
                        <div className="flex flex-wrap">
                            {['Blockchain', 'Cybersecurity', 'Opensource', 'AI'].map(club => (
                                <button
                                    key={club}
                                    onClick={() => setCurrentClub(club)}
                                    className={`mr-4 mb-4 lg:mr-2 ${currentClub === club ? 'bg-blue-500 text-white' : 'bg-gray-300'} rounded-md px-4 py-2`}
                                >
                                    {club}
                                </button>
                            ))}
                    ...
                    <div className="mt-4 p-4 border border-gray-300 rounded-lg flex-grow lg:w-1/3">
