...
const AdminCyberClubRules = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const docRef = await addDoc(collection(db, 'cyberrules'), formData);
    ...
    const handleRemoveSupportItem = async (itemId) => {
        ...
        try {
            const itemDocRef = doc(db, 'cyberrules', itemId);
    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="flex-1 h-full p-8 bg-gray-100">
                ...
                {/* Content area */}
                <div className="mt-6">
                    <h2 className="text-3xl font-semibold mb-6 text-gray-800">Cybersecurity Club Rules and Regulations</h2>
