...
const AdminCyberClubMaterials = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const docRef = await addDoc(collection(db, 'cyberclubmaterials'), formData);
    ...
    const handleRemoveEvent = async (eventId) => {
        ...
        try {
            const eventDocRef = doc(db, 'cyberclubmaterials', eventId);
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const querySnapshot = await getDocs(collection(db, 'cyberclubmaterials'));
