...
import Box4Image from '../Assests/imagesroni/Default_crowd_connsisting_of_students_1.jpg';
                ...
                <div className="flex h-full">
                    <div className="flex flex-col w-1/2 space-y-6 p-4">
                        <button
                            ...
                            onClick={() => navigate('/admin-opensource-events')}
                        >
                            Upcoming Events
                        </button>
                        <button
                        ...
                        <button
                            ...
                            onClick={() => navigate('/admin-opensource-rules')}
                        >
                    ...
                    <div className="flex flex-col w-1/2 space-y-6 p-4">
                        <button
                            ...
                            onClick={() => navigate ('/admin-opensource-club-materials')}
                        >
                            Club Materials
                        </button>
                        <button
                            ...
                            onClick={() => navigate ('/admin-open-duty-leave')}
                        >
                            Attendance
                        </button>
                        <button
                            ...
                            onClick={() => navigate('/admin-opensource-support')}
                        >
                            Support
                        </button>
                    </div>
